...
RUN apt-get update && apt-get install -y unzip fontconfig locales gconf-service \
...
RUN apt-get update && apt-get install -y wget apt-transport-https --no-install-recommends \
